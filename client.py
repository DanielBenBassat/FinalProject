...
def play_song(song_name):
    pygame.mixer.init()
    #pygame.mixer.music.stop()  # עצירת שיר קודם
    pygame.mixer.music.unload()  # ניקוי השיר הקודם מהזיכרון
    pygame.mixer.music.load(song_name)
    pygame.mixer.music.play()
    print(f"Playing {song_name}.mp3... Type 'stop' to stop the music.")

    while pygame.mixer.music.get_busy():  # כל עוד השיר מנגן
...
def post_song(client_socket):
    ...
    msg = "p" + song_name.encode + b"!" + song_bytes
